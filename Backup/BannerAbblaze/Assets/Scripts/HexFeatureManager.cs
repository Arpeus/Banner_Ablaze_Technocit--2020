...
public class HexFeatureManager : MonoBehaviour
{
    ...
    Transform PickPrefab(
        ...
        int level, float hash,bool verification, float choice
    )
    {
        if (level > 0)
        {
    ...
    public void AddFeature(HexCell cell, Vector3 position)
    {
        ...
        Transform prefab = PickPrefab(
            urbanCollections, cell.UrbanLevel, hash.a,cell.IsUrbanLevel, hash.d
        );
        Transform otherPrefab = PickPrefab(
            farmCollections, cell.FarmLevel, hash.b, cell.IsMountainLevel, hash.d
        ...
        otherPrefab = PickPrefab(
            plantCollections, cell.PlantLevel, hash.c,cell.IsPlantLevel, hash.d
        );
        if (prefab)
        {
